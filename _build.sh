...
export PATH=$BUILD_HOME:$PATH

mkdir cilkrt
cd cilkrt
cmake -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_INSTALL_PREFIX=$BUILD_HOME $CLANG_HOME/projects/compiler-rt/lib/cilk
make -j 8 2>&1 | tee build.log
