...
void test_throw() {
  ...
  // CHECK_INVOKE: define void @_ZN19spawn_helper_invoke10test_throwEv
...
void test_nothrow() {
  ...
  // CHECK_INVOKE: define void @_ZN19spawn_helper_invoke12test_nothrowEv
...
void test_nothrow_spec() {
  ...
  // CHECK_INVOKE: define void @_ZN19spawn_helper_invoke17test_nothrow_specEv
  // CHECK_INVOKE: call {{.*}}__cilk_spawn_helper
  // CHECK_INVOKE: ret void
}
...
void test_nothrow_attr() {
  ...
  // CHECK_INVOKE: define void @_ZN19spawn_helper_invoke17test_nothrow_attrEv
  // CHECK_INVOKE: call {{.*}}__cilk_spawn_helper
  // CHECK_INVOKE: ret void
}
