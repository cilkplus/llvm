...
// CHECK:   load i32* %{{.*}}, align 4, !llvm.mem.parallel_loop_access !2
// CHECK:   load i32* %{{.*}}, align 4, !llvm.mem.parallel_loop_access !2
// CHECK:   store i32* %{{.*}}, i32** %{{.*}}, align 8, !llvm.mem.parallel_loop_access !2
// CHECK:   load i32* %__cv_i, align 4, !llvm.mem.parallel_loop_access !2
...
// CHECK:   load i32* %{{.*}}, !llvm.mem.parallel_loop_access !3
// CHECK:   load i32* %__cv_j, align 4, !llvm.mem.parallel_loop_access !3
...
// CHECK:   load i32* %{{.*}}, !llvm.mem.parallel_loop_access !4
// CHECK:   load i32* %{{.*}}, !llvm.mem.parallel_loop_access !4
...
// CHECK-NOT: !llvm.loop
// CHECK-NOT: !llvm.loop
// CHECK:   load i32* %__cv_i, align 4, !llvm.mem.parallel_loop_access !4
