...
// CHECK:   br label %{{.*}}, !llvm.loop.parallel !0
// CHECK:   ret void
...
// CHECK:   br label %{{.*}}, !llvm.loop.parallel !1
// CHECK:   ret void
  _Cilk_for (int i = 0; i < 10; ++i)
...
// CHECK:   br label %{{.*}}, !llvm.loop.parallel !2
// CHECK:   ret void
...
// CHECK:   br label %{{.*}}, !llvm.loop.parallel !3
// CHECK:   ret void
  _Cilk_for (int i = 0; i < 10; ++i)
    for (int j = 0; j < 10; ++j)
      ;
