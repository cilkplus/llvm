...
void test_lcv1(void) {
  ...
  //
  // CHECK-LCV1-NEXT: [[R1:%[a-zA-Z0-9]+]] = load i64, i64*
  ...
  //
  // CHECK-LCV1-NEXT: [[R3:%[a-zA-Z0-9]+]] = load i32, i32*
  ...
  // CHECK-LCV1: call void @__cilkrts_cilk_for_32
  //
  // CHECK-LCV1-NEXT: [[R5:%[a-zA-Z0-9]+]] = load i8, i8*
  ...
  // CHECK-LCV1: call void @__cilkrts_cilk_for_32
  //
  // CHECK-LCV1: [[R5:%[a-zA-Z0-9]+]] = load i16, i16*
  ...
  // CHECK-LCV1: call void @__cilkrts_cilk_for_64
  //
  // CHECK-LCV1-NEXT: [[R7:%[a-zA-Z0-9]+]] = load i64, i64*
...
void test_lcv2(void) {
  ...
  //
  // CHECK-LCV2-NEXT: [[R1:%[a-zA-Z0-9]+]] = load i8*, i8**
  // CHECK-LCV2-NEXT: [[R2:%[a-zA-Z0-9]+]] = getelementptr i8, i8* [[R1]], i[[BIT_WIDTH]] %
  // CHECK-LCV2-NEXT: store i8* [[R2]], i8**

  _Cilk_for (b = &buf[0]; b != &buf[99]; b += 4);
  // CHECK-LCV2: call void @__cilkrts_cilk_for_[[BIT_WIDTH:32|64]]
  //
  // CHECK-LCV2-NEXT: [[R3:%[a-zA-Z0-9]+]] = load i8*, i8**
  // CHECK-LCV2-NEXT: [[R4:%[a-zA-Z0-9]+]] = mul i64 4, %
  // CHECK-LCV2-NEXT: [[R5:%[a-zA-Z0-9]+]] = getelementptr i8, i8* [[R3]], i[[BIT_WIDTH]] %
  ...
  //
  // CHECK-LCV2-NEXT: [[R6:%[a-zA-Z0-9]+]] = load i32, i32*
  // CHECK-LCV2-NEXT: [[R7:%[a-zA-Z0-9]+]] = load i8, i8*
  ...
  // CHECK-LCV2: call void @__cilkrts_cilk_for_[[BIT_WIDTH:32|64]]
  //
  // CHECK-LCV2-NEXT: [[R11:%[a-zA-Z0-9]+]] = load i8*, i8**
  // CHECK-LCV2: [[R12:%[a-zA-Z0-9]+]] = mul i64 %{{.+}}, %
  // CHECK-LCV2-NEXT: [[R13:%[a-zA-Z0-9]+]] = getelementptr i8, i8* [[R11]], i[[BIT_WIDTH]] %
